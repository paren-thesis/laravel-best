    ...
    <section className="bg-panel border border-line rounded-2xl p-6 space-y-4">
      <div>
        <h3 className="text-base font-semibold text-ink flex items-center gap-2">
          <Github className="w-4 h-4 text-accent" /> Submit GitHub &amp; Drive Links
        </h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button
          ...
          className="w-full py-2.5 px-4 min-h-11 bg-emerald-700 hover:bg-emerald-800 disabled:opacity-50 text-white font-medium text-sm rounded-xl transition-all"
        >
